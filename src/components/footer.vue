        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="float-left pull-none">
              ...
              >2020 - {{ new Date().getFullYear()}} © Sadique Shahriar</p>
            </div>
            <div class="float-right pull-none">
              <ul class="list-inline social m-0">
                <li class="list-inline-item">
                  <a href="https://www.facebook.com/sadiq.shahriar/" target="_blank"  class="social-icon">
                ...
                <li class="list-inline-item">
                  <a href="https://www.linkedin.com/in/shahriar-shuvo-032913148/" target="_blank" class="social-icon">
                    <i class="mdi mdi-linkedin"></i>
                  </a>
                </li>
                <li class="list-inline-item">
                  <a href="https://myaccount.google.com/profile" target="_blank" class="social-icon">
